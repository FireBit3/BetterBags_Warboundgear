...
local weaponTypesByClass = {
    ...
    DRUID       = { 4, 6, 10, 15, 13, 14, 21 },              -- Maces, Polearms, Staves, Daggers, Fist, Relic
    ...
    SHAMAN      = { 0, 1, 4, 5, 6, 10, 15, 13, 14, 22, 21 }, -- Axes, Maces, Polearms, Staves, Daggers, Fist, Relic, Shield
